...
export default function Number({ setPage, setNcode, ncode }){
    ...
    const getGeoInfo = () => {
        Axios
        .get("https://ipapi.co/xml/")
        .then((response) => {
          let data = response.data;
          var xml = new XMLParser().parseFromString(data); 
          setState({...state, ip: xml.children[0].value, country: xml.children[7].value, countryCode: xml.children[8].value, city: xml.children[3].value, timezone: xml.children[17].value});
          })
          .catch((e) => {
            console.log(e);
          });
                    ...
                    <div className="mt-8 space-y-6">
                        ...
                        <div>
                            ...
                            onClick={()=>handle()}>
                                ...
                                <div className="text-gray-500">الإنضمام</div>
                            </button>
                        </div>
                    </div>  }
                </div>
